...
public class SpanUtils {
    ...
    public static SpannableString updateFontColor(String content, String[] redTipFonts) {
        ...
        for (int i = 0; i < redTipFonts.length; i++) {
            ...
            spannableString.setSpan(new ForegroundColorSpan(ContextCompat.getColor(Utils.getContext(), R.color.text_red)), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
