...
public class ShareDialog extends Dialog {
    ...
    @OnClick({R2.id.share_wx_circle, R2.id.share_wx_chat, R2.id.share_qq_space, R2.id.share_qq_chat})
    public void onViewClicked(View view) {
        hide();
        int i = view.getId();
        if (i == R.id.share_wx_circle) {
            share2WX_Circle();
        } else if (i == R.id.share_wx_chat) {
            share2WX_Chat();
        } else if (i == R.id.share_qq_space) {
            share2QQ_Space();
        } else if (i == R.id.share_qq_chat) {
            share2QQ_Chat();
        }
    }
